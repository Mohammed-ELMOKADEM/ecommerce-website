...
<title>EcoMo - Qui sommes-nous?</title>
...
<%@include file="jspf/header.jspf" %>
	<main class="main">
            <div class="container">
	        	<div class="page-header page-header-big text-center" style="background-image: url('./images/istockphoto-918381560-170667a.jpg')">
        			<h1 class="page-title text-white">Qui sommes-nous?</h1>
	        	</div><!-- End .page-header -->
            </div><!-- End .container -->
